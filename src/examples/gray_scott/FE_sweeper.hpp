    ...
    namespace heat_FE
    {
        ...
        : public IMEX<SweeperTrait, Enabled>
      {
        static_assert(std::is_same<
                        ...
                        std::integral_constant<size_t, 2>  //ruth_dim  SweeperTrait::DIM
                      >::value,
	  ...
	  typedef Dune::BlockVector<Dune::FieldVector<double, SweeperTrait::NR_OF_COMP> > VectorType;

         
	  MatrixType M_dune, A_dune;
