...
namespace pfasst
{
  namespace examples
  {
    namespace heat_FE
    {
      template<class Basis, class SweeperTrait, typename Enabled>
      void
      Heat_FE<Basis, SweeperTrait, Enabled>::init_opts()
      {
      ...
      template<class Basis, class SweeperTrait, typename Enabled>
      Heat_FE<SweeperTrait, Enabled>::Heat_FE(const Basis &basis, size_t nlevel) // std::shared_ptr<fe_manager> FinEl,
      ...
      template<class Basis, class SweeperTrait, typename Enabled>
      void
      Heat_FE<Basis, SweeperTrait, Enabled>::set_options()
      {
      ...
      template<class Basis, class SweeperTrait, typename Enabled>
      void
      Heat_FE<Basis, SweeperTrait, Enabled>::assemble(){
...
//                   << "      |rel error| = " << LOG_FLOAT << encap::norm0(rel_error[num_nodes])
                                                    ...
                                                    const shared_ptr<typename SweeperTrait::encap_t> rhs)
      {
        ...
        MatrixType M_dtA_dune = MatrixType(A_dune);
