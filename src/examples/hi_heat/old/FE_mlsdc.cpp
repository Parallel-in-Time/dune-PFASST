...
const int BASIS_ORDER1 = 1;
const int BASIS_ORDER2 = 2;
...
namespace pfasst
{
  namespace examples
  {
    namespace heat_FE
    {
      ...
      using sweeper_t_fine   = Heat_FE<dune_sweeper_traits<encap_traits_t, 1, DIMENSION>>;
...
int main(int argc, char** argv)
{
  ...
  using pfasst::quadrature::QuadratureType;
  using sweeper_t_1 = pfasst::examples::heat_FE::Heat_FE<pfasst::examples::heat_FE::dune_sweeper_traits<encap_traits_t, 1, DIMENSION>>;
  using sweeper_t_2 = pfasst::examples::heat_FE::Heat_FE<pfasst::examples::heat_FE::dune_sweeper_traits<encap_traits_t, 2, DIMENSION>>;
  ...
  pfasst::examples::heat_FE::run_mlsdc(nelements, DIMENSION, coarse_factor, nnodes, quad_type, t_0, dt, t_end, niter);
}
#endif 
