    ...
    SpectralTransfer<
            ...
            typename enable_if<
                    is_same<
                            ...
                            integral_constant<size_t, dim>
                    >::value
            >::type>::set_matrix(Dune::BCRSMatrix <Dune::FieldMatrix<double, 2, 2>> interpolate, Dune::BCRSMatrix <Dune::FieldMatrix<double, 2, 2>> restrict)
    {
                                       ...
                                       shared_ptr<typename TransferTraits::coarse_encap_t> coarse)
    {
      ...
      if (fine_ndofs == coarse_ndofs) {
        ...
        coarse->data() = fine->get_data();
          ...
          //Transfer_matrix.mtv(fine->data(), coarse->data());
