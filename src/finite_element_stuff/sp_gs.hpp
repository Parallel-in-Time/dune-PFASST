...
#include "../examples/gray_scott/dune_vec_multi.hpp"
...
namespace pfasst
{
  namespace contrib
  {
	...
	//explicit SpectralTransfer(std::shared_ptr<fe_manager> FinEl, size_t nlevel);
        ...
        virtual void set_matrix(Dune::BCRSMatrix <Dune::FieldMatrix<double, 2, 2>> interpolate, Dune::BCRSMatrix <Dune::FieldMatrix<double, 2, 2>> restrict);
...
#include "spectral_transfer_gs_impl.hpp"
