...
namespace pfasst
{
  ...
  >
  class Sweeper
    : public std::enable_shared_from_this<Sweeper<SweeperTrait, MatrixType, Enabled>>
  {
    public:
      /**
    ...
    /*static_assert(std::is_constructible<typename traits::encap_t, typename traits::encap_t::GFS>::value,
                  "Encapsulation type must be constructible");*/ //vorsicht ruth fehler
    ...
    public:
      //! @{
      explicit Sweeper();
      Sweeper(const Sweeper<SweeperTrait, MatrixType, Enabled>& other) = default;
      Sweeper(Sweeper<SweeperTrait, MatrixType, Enabled>&& other) = default;
      virtual ~Sweeper() = default;
      Sweeper<SweeperTrait, MatrixType, Enabled>& operator=(const Sweeper<SweeperTrait, MatrixType, Enabled>& other) = default;
      Sweeper<SweeperTrait, MatrixType, Enabled>& operator=(Sweeper<SweeperTrait, MatrixType, Enabled>&& other) = default;
      //! @}
...
#include "pfasst/sweeper/sweeper_impl2.hpp"
