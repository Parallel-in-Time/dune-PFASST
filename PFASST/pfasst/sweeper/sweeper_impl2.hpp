...
namespace pfasst
{
  ...
  Sweeper<SweeperTrait, MatrixType, Enabled>::Sweeper()
    :   _quadrature(nullptr)
  ...
  Sweeper<SweeperTrait, MatrixType, Enabled>::quadrature()
  {
  ...
  Sweeper<SweeperTrait, MatrixType, Enabled>::get_quadrature() const
  {
    return this->_quadrature;
  }
  ...
  Sweeper<SweeperTrait, MatrixType, Enabled>::status()
  {
    return this->_status;
  }
  ...
  Sweeper<SweeperTrait, MatrixType, Enabled>::get_status() const
  {
    return this->_status;
  }
  ...
  Sweeper<SweeperTrait, MatrixType, Enabled>::encap_factory()
  {
  ...
  Sweeper<SweeperTrait, MatrixType, Enabled>::get_encap_factory() const
  {
    return *(this->_factory);
  }
  ...
  Sweeper<SweeperTrait, MatrixType, Enabled>::initial_state()
  {
  ...
  Sweeper<SweeperTrait, MatrixType, Enabled>::get_initial_state() const
  {
    if (this->get_states().size() == 0) {
      ML_CLOG(ERROR, this->get_logger_id(), "Sweeper need to be setup first before querying initial state.");
      throw std::runtime_error("sweeper not setup before querying initial state");
  ...
  Sweeper<SweeperTrait, MatrixType, Enabled>::states()
  {
    return this->_states;
  }
  ...
  Sweeper<SweeperTrait, MatrixType, Enabled>::get_states() const
  {
    return this->_states;
  }
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  vector<shared_ptr<typename SweeperTrait::encap_t>>&
  Sweeper<SweeperTrait, MatrixType, Enabled>::previous_states()
  {
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  const vector<shared_ptr<typename SweeperTrait::encap_t>>&
  Sweeper<SweeperTrait, MatrixType, Enabled>::get_previous_states() const
  {
    return this->_previous_states;
  }
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  shared_ptr<typename SweeperTrait::encap_t>&
  Sweeper<SweeperTrait, MatrixType, Enabled>::end_state()
  {
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  const shared_ptr<typename SweeperTrait::encap_t>
  Sweeper<SweeperTrait, MatrixType, Enabled>::get_end_state() const
  {
    return this->_end_state;
  }
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  vector<shared_ptr<typename SweeperTrait::encap_t>>&
  Sweeper<SweeperTrait, MatrixType, Enabled>::tau()
  {
    return this->_tau;
  }
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  const vector<shared_ptr<typename SweeperTrait::encap_t>>&
  Sweeper<SweeperTrait, MatrixType, Enabled>::get_tau() const
  {
    return this->_tau;
  }
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  vector<shared_ptr<typename SweeperTrait::encap_t>>&
  Sweeper<SweeperTrait, MatrixType, Enabled>::residuals()
  {
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  const vector<shared_ptr<typename SweeperTrait::encap_t>>&
  Sweeper<SweeperTrait, MatrixType, Enabled>::get_residuals() const
  {
    return this->_residuals;
  }
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  void
  Sweeper<SweeperTrait, MatrixType, Enabled>::set_logger_id(const string& logger_id)
  {
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  const char*
  Sweeper<SweeperTrait, MatrixType, Enabled>::get_logger_id() const
  {
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  void
  Sweeper<SweeperTrait, MatrixType, Enabled>::set_options()
  {
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  void
  Sweeper<SweeperTrait, MatrixType,Enabled>::set_abs_residual_tol(const typename SweeperTrait::spatial_t& abs_res_tol)
  {
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  void
  Sweeper<SweeperTrait, MatrixType, Enabled>::set_rel_residual_tol(const typename SweeperTrait::spatial_t& rel_res_tol)
  {
  ...
  template<class SweeperTrait, class MatrixType,  typename Enabled>
  void
  Sweeper<SweeperTrait, MatrixType, Enabled>::initialize()
  {
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  void
  Sweeper<SweeperTrait, MatrixType, Enabled>::setup()
  {
    if (this->get_status() == nullptr) {
      throw std::runtime_error("Status not yet set.");
    }
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  void
  Sweeper<SweeperTrait, MatrixType, Enabled>::reset()
  {
...
//     ML_CVLOG(1, this->get_logger_id(), "solution at t_end: " << to_string(this->get_end_state()));
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  void
  Sweeper<SweeperTrait, MatrixType, Enabled>::advance(const size_t& num_steps)
  {
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  void
  Sweeper<SweeperTrait, MatrixType, Enabled>::advance()
  {
    this->advance(1);
  }
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  void
  Sweeper<SweeperTrait, MatrixType, Enabled>::spread()
  {
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  void
  Sweeper<SweeperTrait, MatrixType, Enabled>::save()
  {
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  void
  Sweeper<SweeperTrait, MatrixType, Enabled>::reevaluate(const bool initial_only)
  {
    UNUSED(initial_only);
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  void
  Sweeper<SweeperTrait, MatrixType, Enabled>::reevaluate()
  {
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  vector<shared_ptr<typename SweeperTrait::encap_t>>
  Sweeper<SweeperTrait, MatrixType, Enabled>::integrate(const typename SweeperTrait::time_t& dt)
  {
    UNUSED(dt);
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  bool
  Sweeper<SweeperTrait, MatrixType, Enabled>::converged(const bool pre_check)
  {
    ...
    template<class SweeperTrait, class MatrixType, typename Enabled>
    bool
    Sweeper<SweeperTrait, MatrixType, Enabled>::alternative_converged(const bool pre_check) //u^{k+1} - u^k, wird mit false aufgerufen
    {
      this->compute_residuals(pre_check);
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  bool
  Sweeper<SweeperTrait, MatrixType, Enabled>::converged()
  {
  ...
  template<class SweeperTrait, class MatrixType,  typename Enabled>
  void
  Sweeper<SweeperTrait, MatrixType, Enabled>::integrate_end_state(const typename SweeperTrait::time_t& dt)
  {
    UNUSED(dt);
    assert(this->get_quadrature() != nullptr);
...
//       ML_CVLOG(1, this->get_logger_id(), "end state: " << to_string(this->get_end_state()));
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  void
  Sweeper<SweeperTrait, MatrixType, Enabled>::compute_residuals(const bool& only_last)
  {
    UNUSED(only_last);
  ...
  template<class SweeperTrait, class MatrixType, typename Enabled>
  void
  Sweeper<SweeperTrait, MatrixType, Enabled>::compute_residuals()
  {
