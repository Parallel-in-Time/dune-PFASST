...
%\begin{minipage}{0.2\linewidth}
  \begin{center}
  	  \begin{tikzpicture}[scale=1]
		  \begin{loglogaxis}[01_temp, ymax=1e-04,ymin=1e-09,xlabel={$\Delta t$},ylabel={Fehler $e_{\Delta t}$},grid=major]	
			\addplot table[x index = 1, y index = 2] {4096.dat};
			\addplot table[x index = 1, y index = 2] {8192.dat};
			\addplot table[x index = 1, y index = 2] {16384.dat};
			\addplot table[x index = 1, y index = 2] {32768.dat};
		   \legend{4096, 8192, 16384, 32768}
		  \end{loglogaxis}
	  \end{tikzpicture}
  \end{center}
%\end{minipage}
