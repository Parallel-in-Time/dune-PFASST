  ...
  \begin{center}
  	  \begin{tikzpicture}[scale=1]
		  \begin{loglogaxis}[01_temp, ymax=1e-02,ymin=1e-09,xlabel={$\Delta t$},ylabel={Fehler $e_{\Delta t}$},grid=major]	
			\addplot table[x index = 1, y index = 2] {../../../build-cmake/src/examples/hi_heat/solution_mlsdc/16.dat};
			\addplot table[x index = 1, y index = 2] {../../../build-cmake/src/examples/hi_heat/solution_mlsdc/32.dat};
			\addplot table[x index = 1, y index = 2] {../../../build-cmake/src/examples/hi_heat/solution_mlsdc/64.dat};
		   \legend{16, 32, 64}
		  \end{loglogaxis}
	  \end{tikzpicture}
  \end{center}
