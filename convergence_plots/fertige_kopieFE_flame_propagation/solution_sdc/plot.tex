...
%\begin{minipage}{0.2\linewidth}
  \begin{center}
  	  \begin{tikzpicture}[scale=1]
		  \begin{loglogaxis}[01_temp, ymax=1,ymin=1e-5,xlabel={$\Delta t$},ylabel={Fehler $e_{\Delta t}$},grid=major]
		  	\addplot table[x index = 1, y index = 2] {../../../build-cmake/src/examples/fertige_kopieFE_flame_propagation/solution_sdc/128.dat};	
		  			  	\addplot table[x index = 1, y index = 2] {../../../build-cmake/src/examples/fertige_kopieFE_flame_propagation/solution_sdc/256.dat};		  
